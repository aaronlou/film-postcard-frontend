  ...
  ({ data }, ref) => {
    ...
    return (
      <div className="flex justify-center items-center">
        <div 
          ref={ref}
          className="bg-gradient-to-br from-amber-50 to-stone-100 p-6 rounded-2xl shadow-2xl"
        ...
        >
          <div className="bg-white h-full rounded-xl shadow-inner p-4 flex flex-col">
            ...
            {image ? (
              ...
              <div className="h-64 bg-gradient-to-br from-stone-100 to-stone-200 rounded-lg flex items-center justify-center mb-4">
