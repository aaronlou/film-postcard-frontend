  ...
  ({ data }, ref) => {
    ...
    return (
      <div className="flex justify-center items-center">
        <div 
          ref={ref}
          className="bg-gradient-to-br from-[#faf8f5] to-[#f5f0e8] rounded-lg shadow-2xl overflow-hidden"
        ...
        >
          ...
          {image ? (
            ...
            <div className="h-[340px] bg-gradient-to-br from-stone-100 to-stone-200 flex items-center justify-center">
          ...
          <div className="h-[240px] bg-white/80 p-8 flex flex-col justify-between relative">
            ...
            <div className="absolute top-0 left-8 right-8 h-px bg-gradient-to-r from-transparent via-stone-300 to-transparent" />
